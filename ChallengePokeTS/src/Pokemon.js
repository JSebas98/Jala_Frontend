...
exports.PokemonTrainer = exports.Pokemon = exports.getInfoPokemon = exports.getSinglePokemon = void 0;
...
function getInfoPokemon(id) {
    var pokemonData = getSinglePokemon(id);
    var name = pokemonData.then(function (res) {
